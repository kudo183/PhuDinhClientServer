...
namespace Client.ViewModel
{
    public partial class TChuyenHangDonHangViewModel : BaseViewModel<TChuyenHangDonHangDto>
    {
        ...
        partial void ProcessDtoBeforeAddToEntitiesPartial(TChuyenHangDonHangDto dto)
        {
            ...
            {
                dto.TChuyenHang.RNhanVien = ReferenceDataManager<RNhanVienDto>.Instance.GetList().Find(p => p.Ma == dto.TChuyenHang.MaNhanVienGiaoHang);
            }
            ...
            {
                item.RKhachHang = ReferenceDataManager<RKhachHangDto>.Instance.GetList().Find(p => p.Ma == item.MaKhachHang);
                item.RKhoHang = ReferenceDataManager<RKhoHangDto>.Instance.GetList().Find(p => p.Ma == item.MaKhoHang);
            }
