...
BEGIN
	...
	BEGIN
		...
		INSERT INTO tTonKho(MaKhoHang, MaMatHang, Ngay, SoLuong, SoLuongCu, GroupID)
		SELECT MaKhoHang, MaMatHang, @NextDay, SoLuong, SoLuongCu, GroupID FROM tTonKho where Ngay = @CurrentDay;
		
		INSERT INTO tCongNoKhachHang(MaKhachHang, Ngay, SoTien, GroupID)
		SELECT MaKhachHang, @NextDay, SoTien, GroupID FROM tCongNoKhachHang where Ngay = @CurrentDay;
